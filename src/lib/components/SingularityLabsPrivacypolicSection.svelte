...
<section class="mt-20 flex min-h-screen max-w-full flex-col gap-10 overflow-hidden px-4 md:px-0" id="cloud">
    ...
    <div class="flex flex-col items-center gap-8">
        ...
        <div class="text-left text-slate-400 sm:max-w-2xl sm:text-xl flex flex-col gap-2">
            ...
            <li class="list-square">
                <b>Company</b> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to SingularityLabs.
            </li>
            <li class="list-square">
            ...
            <li class="list-square">
                <b>Website</b> refers to SingularityLabs, accessible from <a  href='https://github.com/SingularityLabs-ai/'> SingularityLabs Github Page </a>
            </li>
            <li class="list-square">
