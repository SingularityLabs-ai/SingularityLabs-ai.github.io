...
<div class="flex flex-col gap-20 px-4 text-slate-300 md:px-24" id="download">
	<h1 class="text-4xl font-semibold text-slate-200">Download SingularityLabs</h1>
...
<Modal bind:showModal={showLinuxModal}>
	...
	>
		...
		>
			<a
				href="https://github.com/SingularityLabs-ai/singularitylabs/releases/download/v2.8.6/singularitylabs-2.8.6-linux.AppImage"
				target="_blank"
				rel="noreferrer noopener">AppImage (Universal Portable)</a
			>
			<a
				href="https://flathub.org/apps/org.singularitylabs.SingularityLabs"
				target="_blank"
				rel="noreferrer noopener">Flatpak (Universal)</a
			>
			<a href="https://snapcraft.io/singularitylabs/" target="_blank" rel="noreferrer noopener"
				>Snap Store</a
			>
			<a
				href="https://github.com/SingularityLabs-ai/singularitylabs/releases/download/v2.8.6/singularitylabs-2.8.6-linux.deb"
				target="_blank"
				rel="noreferrer noopener">DEB (Debian/Ubuntu based)</a
			>
			<a
				href="https://github.com/SingularityLabs-ai/singularitylabs/releases/download/v2.8.6/singularitylabs-2.8.6-linux.rpm"
				target="_blank"
				rel="noreferrer noopener">RPM (Fedora based)</a
			>
			<a
				href="https://github.com/SingularityLabs-ai/singularitylabs/releases/download/v2.8.6/singularitylabs-2.8.6-linux.zip"
				target="_blank"
				rel="noreferrer noopener">ZIP (Universal Portable)</a
			>
			<a
				href="https://aur.archlinux.org/packages/singularitylabs-bin"
				target="_blank"
...
<Modal bind:showModal={showMacModal}>
	...
	>
		...
		>
			<a
				href="https://github.com/SingularityLabs-ai/singularitylabs/releases/download/v2.8.6/singularitylabs-2.8.6-mac.dmg"
				target="_blank"
...
<Modal bind:showModal={showWindowsModal}>
	...
	>
		...
		>
			<a
				href="https://github.com/SingularityLabs-ai/singularitylabs/releases/download/v2.8.6/singularitylabs-2.8.6-win.exe"
				target="_blank"
